...
<svelte:head>
	<title>Brian Casey | Web Developer | About</title>
</svelte:head>
	...
	<PageContent {content} >
		<div class="container">
			<div class="content">
				...
				<p>My main bread and butter is as a Data Analyst and SQL Developer/Admin (SQL Server) and ERP specialist (Dynamics SL) for a mid-sized engineering and construction company but I'm also a web developer and web consultant. I come from a finance and project accounting background (my degree and original professional experience).</p>
